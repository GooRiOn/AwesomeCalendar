...
namespace AwesomeCalendar.Domain.DependencyInjection
{
    public class Registration
    {
        public static void Register(ContainerBuilder containerBuilder)
        {
            ...
            containerBuilder.RegisterType<DeleteCalendarItemCycleCommandHandler>().As<ICommandHandler<DeleteCalendarItemCycleCommand>>();
            ...
            containerBuilder.RegisterType<CalendarItemCycleDeletedEventHandler>().As<IEventHandler<CalendarItemCycleDeletedEvent>>();
        }
    }
}
